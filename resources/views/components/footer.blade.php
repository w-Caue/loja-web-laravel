<footer class="bg-white rounded-t mt-32">
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                <div class="col-span-2">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">
                            Receba as promoções pelo o seu email!</h2>
                ...
                <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                    <form class="w-full">
                        ...
                        <div class="border border-gray-100 p-2 focus-within:ring sm:flex sm:items-center sm:gap-4">
                            <input type="email" id="UserEmail" placeholder="codesete@gmail.com"
                                class="w-full border-none focus:border-transparent focus:ring-transparent sm:text-sm" />

                            <button
                                class="mt-1 w-full bg-blue-600 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-indigo-600 sm:mt-0 sm:w-auto sm:shrink-0">
                                Inscrever-se
                            </button>
                        </div>
                    </form>
        ...
        <div class="mt-8 border-t border-gray-100 pt-8">
            <div class="sm:flex sm:justify-between">
                <p class="text-xs text-gray-500">&copy; 2024. Code Sete desenvolvimento</p>
